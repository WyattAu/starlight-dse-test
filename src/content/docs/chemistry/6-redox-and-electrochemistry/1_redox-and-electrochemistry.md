...
Half-cells connected by a wire (external circuit) and a salt bridge (internal circuit).
...
Discharged. The product at each electrode depends on the relative reactivity of the ions.
...
**Problem.** Balance: MnO$_4^-$ + Fe$^{2+}$ + H$^+$ $\to$ Mn$^{2+}$ + Fe$^{3+}$ + H$_2$O.

**Solution.** Oxidation: Fe$^{2+}$ $\to$ Fe$^{3+}$ + $e^-$. Reduction: MnO$_4^-$ + 8H$^+$ + 5$e^-$
$\to$ Mn$^{2+}$ + 4H$_2$O. Multiply oxidation by 5: MnO$_4^-$ + 5Fe$^{2+}$ + 8H$^+$ $\to$
Mn$^{2+}$ + 5Fe$^{3+}$ + 4H$_2$O.
...
**Problem.** What mass of Cu is deposited when $2.5 \mathrm{ A}$ flows through CuSO$_4$ for 30
minutes?

**Solution.** $Q = 2.5 \times 1800 = 4500 \mathrm{ C}$.
$n(e^-) = 4500/96500 = 0.0466 \mathrm{ mol}$. $n(\text{Cu}) = 0.0466/2 = 0.0233 \mathrm{ mol}$. Mass
$= 0.0233 \times 63.5 = 1.48 \mathrm{ g}$.

$\blacksquare$

## Summary

- Oxidation numbers: assign using standard rules; redox involves changes in oxidation number.
- Balancing: split into half-equations, balance atoms, charge with electrons, then combine.
- Electrolysis: $Q = It = nF$; Faraday's laws relate charge to amount deposited.
